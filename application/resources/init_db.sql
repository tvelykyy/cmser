...
CREATE TABLE `page_page_field` (
  ...
  `page_field_content` blob NOT NULL COMMENT 'Reprents page block content for specific page.',
...
INSERT INTO `page_page_field` VALUES ('2', '1', 0x54686973206973206E65777320706167652E);
